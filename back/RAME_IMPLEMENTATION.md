# Implémentation du Système Rames de papier Physique

## Vue d'ensemble

Le système Rames de papier (Restaurant et Matériel Éducatif) permet aux étudiants de payer soit électroniquement via le système de paiement normal, soit physiquement en apportant leur propre repas/matériel.

## Composants Implémentés

### 1. Tranche de Paiement Rames de papier
...
INSERT INTO payment_tranches (
    ...
    'Rames de papier', 
    'Frais Rames de papier (Restaurant et Matériel Éducatif) - Paiement physique uniquement', 
    6, 
    1, 
    25000, 
    1, 
...
- **Fonctionnalités :**
  - Vérifie que la Rames de papier n'a pas déjà été payée (physique ou électronique)
...
- Exclut automatiquement la tranche Rames de papier des calculs normaux (ligne 60)
- Les montants "restants" n'incluent pas la Rames de papier
- La Rames de papier est gérée séparément du flux de paiement principal
...
PaymentTranche::active()
    ->ordered()
    ->where('name', '!=', 'Rames de papier') // ← Exclusion de la Rames de papier

// Exclusion des paiements Rames de papier physiques
...
- Interface complète pour la Rames de papier déjà implémentée
- Options radio : "Ne pas payer", "Espèce", "Physique"
- Appel API `payRamePhysically` avec confirmation SweetAlert2
- Affichage du statut Rames de papier distinct des autres paiements
...
**Gestion automatique :**
- Lors d'un paiement Rames de papier physique, envoi automatique d'une notification
- Message formaté spécialement pour la Rames de papier physique
- Génération d'image de reçu incluse

## Utilisation

### Flux de Paiement Rames de papier Physique
...
3. **Vérifications automatiques :**
   - Pas de double paiement Rames de papier
...
### Flux de Paiement Rames de papier Électronique

La Rames de papier peut aussi être payée électroniquement comme une tranche normale :
...
2. **Intégrité :** Impossible de payer deux fois la Rames de papier
3. **Traçabilité :** Historique complet des paiements physiques
4. **Notifications :** Parents informés automatiquement
5. **Séparation :** La Rames de papier n'interfère pas avec les calculs de réduction
...
3. Dans la school Rames de papier, choisir "Physique (rame apportée)"
4. Confirmer le paiement
5. Vérifier la notification WhatsApp et le reçu généré

## Configuration

La tranche Rames de papier est maintenant créée avec :
- **Nom :** Rames de papier
- **Montant :** 25 000 FCFA
