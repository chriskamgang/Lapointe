...
class AddElectrotechniqueSeeder extends Seeder
{
    public function run(): void
    {
        $this->command->info('🔧 Ajout de la spécialité Électrotechnique...');
        ...
        foreach ($btsLevels as $level) {
            ...
            $class = SchoolClass::updateOrCreate(
                ...
                [
                    ...
                    'speciality_code' => 'ELECTROTECHNIQUE',
                    'category' => 'standard',
                    'is_active' => true
                ]
            );
            ...
            $series = ClassSeries::firstOrCreate(
        ...
        $this->command->info('✅ Spécialité Électrotechnique ajoutée avec succès !');
    }
    ...
    private function configurePayments($class)
    {
        ...
        // Montants pour BTS ESSIT standard
        $amounts = [
